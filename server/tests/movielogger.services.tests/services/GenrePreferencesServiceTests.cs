...
public class GenrePreferencesServiceTests : BaseServiceTest
{
    ...
    public async Task GetUserGenrePreferencesAsync_UserExistsWithUserMovieViewings_ReturnsCorrectSummary()
    {
        // // Arrange
        // var userId = 1;
        ...
        //     .With(v => v.MovieId, movie.Id)
        //     .With(v => v.Movie, movie)
        //     .Create();
        ...
        // var mockUserMovieViewingsSet = viewings.BuildMockDbSet();

        // _dbContext.Users.Returns(mockUsersSet);
        // _dbContext.UserMovieViewings.Returns(mockUserMovieViewingsSet);
    ...
    [Fact(Skip = "Test needs update for new UserMovieViewing structure")]
    public async Task GetUserGenrePreferencesAsync_UserExistsButNoUserMovieViewings_ReturnsEmptySummary()
    {
        // // Arrange
        // var userId = 1;
        // var user = Fixture.Build<User>().With(u => u.Id, userId).With(u => u.IsDeleted, false).Create();
        // var users = new List<User> { user }.AsQueryable();
        // var viewings = new List<UserMovieViewing>().AsQueryable();
    ...
    public async Task GetUserGenrePreferencesAsync_MultipleGenres_CalculatesCorrectPercentages()
    {
        ...
        // var actionViewing1 = Fixture.Build<UserMovieViewing>().With(v => v.UserId, actionUserMovie.Id).With(v => v.UserMovie, actionUserMovie).Create();
        // var actionViewing2 = Fixture.Build<UserMovieViewing>().With(v => v.UserId, actionUserMovie.Id).With(v => v.UserMovie, actionUserMovie).Create();
        // var comedyViewing = Fixture.Build<UserMovieViewing>().With(v => v.UserId, comedyUserMovie.Id).With(v => v.UserMovie, comedyUserMovie).Create();

        // var users = new List<User> { user }.AsQueryable();
        // var viewings = new List<UserMovieViewing> { actionViewing1, actionViewing2, comedyViewing }.AsQueryable();
    ...
    public async Task GetTopGenresByWatchCountAsync_ReturnsCorrectCount()
    {
        ...
        // var viewing1 = Fixture.Build<UserMovieViewing>().With(v => v.UserId, userMovie1.Id).With(v => v.UserId, userId1).Create();
        // var viewing2 = Fixture.Build<UserMovieViewing>().With(v => v.UserId, userMovie2.Id).With(v => v.UserId, userId2).Create();
        // var viewing3 = Fixture.Build<UserMovieViewing>().With(v => v.UserId, userMovie3.Id).With(v => v.UserId, userId3).Create();

        // var users = new List<User> { user }.AsQueryable();
        // var viewings = new List<UserMovieViewing> { viewing1, viewing2, viewing3 }.AsQueryable();
    ...
    public async Task GetTopGenresByRatingAsync_ReturnsCorrectOrder()
    {
        ...
        // var users = new List<User> { user }.AsQueryable();
        // var viewings = new List<UserMovieViewing> { viewing1, viewing2 }.AsQueryable();
    ...
    public async Task GetLeastWatchedGenresAsync_ReturnsCorrectOrder()
    {
        ...
        // var viewing1 = Fixture.Build<UserMovieViewing>().With(v => v.UserId, userMovie1.Id).With(v => v.UserId, userId1).Create();
        // var viewing2 = Fixture.Build<UserMovieViewing>().With(v => v.UserId, userMovie2.Id).With(v => v.UserId, userId2).Create();
        // var viewing3 = Fixture.Build<UserMovieViewing>().With(v => v.UserId, userMovie2.Id).With(v => v.UserId, userId2).Create();
